...
void main()
{
    ...
    // Pattern 31
    // float lightX = 0.15 / distance(vec2(vUv.x ,(vUv.y - 0.5) * 5.0 + 0.5), vec2(0.5));
    // float lightY = 0.15 / distance(vec2((vUv.x - 0.5) * 5.0 + 0.5 , vUv.y), vec2(0.5));
    // float strength = lightX * lightY;

    // Pattern 32
    // vec2 rotateUv = rotate(vUv, PI * 0.25, vec2(0.5));
    // float lightX = 0.15 / distance(vec2(rotateUv.x,(rotateUv.y - 0.5) * 5.0 + 0.5), vec2(0.5));
    // float lightY = 0.15 / distance(vec2((rotateUv.x -  0.5) * 5.0 + 0.5  , rotateUv.y), vec2(0.5));
